...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        for user in self.USERS[:radiobuttons_in_row]:
            first_row_user = tk.Radiobutton(self,
                                            text=user,
                                            font=best_font,
                                            variable=self.user,
                                            value=user,
        ...
        column = 0
        for user in self.USERS[radiobuttons_in_row:]:
            second_row_user = tk.Radiobutton(self,
                                             text=user,
                                             font=best_font,
                                             variable=self.user,
                                             value=user,
        ...
        # send spam to all ur haters
        submit_spam = tk.Button(self,
                                text="Отправить\nрассылку",
                                font=best_font,
                                fg='black',
                                bg='firebrick1',
    ...
    def send_spam(self):
        ...
        message = MIMEText(self.text.get('1.0'))
        message['Subject'] = self.subject
        print(self.subject)
        message['From'] = self.my_address

        # TODO: sleep before send
